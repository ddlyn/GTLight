...
def parse_args():
    ...
    parser.add_argument("--memo", type=str, default='transformer')
    parser.add_argument("-b", action="store_true",default=0, help="run baseline analysis")
...
def print_samples():
    ...
    f=open("/colight/records/1Transformer_100_4_4_synthetic/anon_4_4_700_0.3_synthetic.json_10_20_11_11_28/test_round/round_0/attention.pkl","rb")
    samples = []
    try:
        while 1:
